  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Success Toast with Full Name
        toast.success(`Welcome ${data.fullName} to Darukaa Earth!`, {
          duration: 4000,
          icon: '🎉',
        });

        // Redirect to dashboard (Admin route as requested)
      ...
      <div className="w-full max-w-md bg-white/[0.03] backdrop-blur-xl rounded-[32px] shadow-2xl border border-white/10 p-10 relative z-10 transition-all hover:border-white/20">
        <div className="text-center mb-12">
          ...
          <h2 className="text-4xl font-black text-white tracking-tighter mb-2">
            Welcome <span className="text-[#11ccf5]">Back</span>
          </h2>
          <p className="text-gray-500 text-sm font-medium tracking-wide border-t border-white/5 pt-4 inline-block">SECURE ACCESS PORTAL</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="relative group">
            ...
            <input
              ...
              className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 pl-12 pr-4 text-white placeholder-gray-600 focus:outline-none focus:border-[#11ccf5]/50 focus:bg-white/[0.07] transition-all"
              required
            />
          </div>
          ...
          <div className="relative group">
            ...
            <input
              ...
              onChange={handleChange}
              className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 pl-12 pr-12 text-white placeholder-gray-600 focus:outline-none focus:border-[#11ccf5]/50 focus:bg-white/[0.07] transition-all"
              required
            />
            <button
              type="button"
        ...
        <div className="mt-12 text-center">
          <p className="text-gray-500 text-xs font-bold tracking-[2px] uppercase mb-4">New to the platform?</p>
          <Link to="/register" className="text-[#11ccf5] hover:text-white font-black text-sm tracking-tight transition-all border-b border-[#11ccf5]/20 hover:border-[#11ccf5]">
